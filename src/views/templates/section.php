...
// Transparent Header
$attrs['avb-header-transparent'] = $section['header_transparent'] ? $section['header_transparent'] : false;
$attrs['avb-header-transparent-placeholder'] = $section['header_transparent'] && !$section['header_transparent_noplaceholder'];
